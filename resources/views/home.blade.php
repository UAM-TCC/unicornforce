...
@section('content')
    ...
    <section class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="documentation.html" class="text-decoration-none text-white">
                    <div class="border rounded-1 border-700 h-100 features-items">
    ...
    <section>
        <div class="container">
            ...
            <div class="p-5 d-flex flex-column justify-content-xl-between flex-xl-row">
                ...
                <button class="btn btn-primary rounded-3 mt-4"><a class="text-decoration-none text-white" href="./form.html">INSCREVA-SE</a><span class="fas fa-arrow-right"></span></button>
                </div>
            </div>
            </div>
        </div>
