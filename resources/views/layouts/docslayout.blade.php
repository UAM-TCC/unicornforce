    ...
    <div class="main-section row m-0 mt-4">
        <div class="col-4 col-md-2 side-bar mt-5 p-0 m-0">
            <div class="w-100 p-1" id="side-section-1">
                <div style="font-size: 22px; padding-top: 19px;" id="items-side-1" class="mr-5 side-links">Testes</div>
                <ul class="mt-1 d-none">
                    <li class="mt-2">
                        <a style="font-size: 18px;" class="text-white" href="{{ route('indexdocs') }}">Como são feitos</a>
                    </li>

                    <li class="mt-2">
                        <a style="font-size: 18px;" class="text-white" href="{{ route('tests') }}">Celulares testados</a>
                    </li>
                </ul>
            </div>
        </div>
